      ...
      <div className="p-10 xs:p-0 mx-auto md:w-full md:max-w-md">
        ...
        <div className="bg-white shadow w-full rounded-lg divide-y divide-gray-200">
          <form onSubmit={handleSignup} className="px-5 py-7">
            ...
            <input id="username" type="text" className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" placeholder="username" required={true} value={userData.username} onChange={e => setUserData(state => ({...state, username: e.target.value}))} />

            <label htmlFor="email" className="font-semibold text-sm text-gray-600 pb-1 block">E-mail</label>
            <input id="email" type="email" className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" placeholder="user@mail.com" required={true} value={userData.email} onChange={e => setUserData(state => ({...state, email: e.target.value}))} />
            ...
            <label htmlFor="confirmPassword" className="font-semibold text-sm text-gray-600 pb-1 block">Confirm Password</label>
            <input id="confirmPassword" type="password" className="border rounded-lg px-3 py-2 mt-1 mb-5 text-sm w-full" placeholder="******************" required={true} value={userData.confirmPassword} onChange={e => setUserData(state => ({...state, confirmPassword: e.target.value}))} />
            ...
            <p className="text-center text-gray-600 text-sm mt-6">
              Already have an account? <Link className="font-bold text-blue-500 hover:text-blue-800" href="/login">Log in</Link>
            </p>
          </form>
          <div className="py-5">
